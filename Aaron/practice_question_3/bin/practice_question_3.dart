import 'package:practice_question_3/practice_question_3.dart' as practice_question_3;
import 'dart:io';
...
void main(List<String> arguments) {
  ...
  print(practice_question_3.myName());
  ...
  print(practice_question_3.getEvenNumbers(num1, num2));
  ...
  print('$base ^ $expnt = ${practice_question_3.calculatePow(base, expnt)}');
  ...
  print('The sum of $num4 and $num5 is: ${practice_question_3.add(num4, num5)}');
  ...
  print('The largest number between $num6, $num7, and $num8 is: ${practice_question_3.maxNumber(num6, num7, num8)}');
  ...
  print('Is $num9 an even number? ${practice_question_3.isEven(num9)}');
  ...
  Map<String, dynamic> user1 = practice_question_3.createUser(name, age);
  ...
  print('The area of a reactangle with length of $length and width of $width is: ${practice_question_3.calculateArea(length, width)}');
