...
void runPractice(){
  ...
  main_util.jaysel.split('').reversed.join();
  ...
  int a = 6, b = 7, c = 1;
  print("In $a, $b, $c, ${practice_three_utils.getHighestNumber(a, b, c)}");
  ...
  print("Write a function in Dart called calculateArea that calculates the area of a rectangle. It should take length and width as arguments, with a default value of 1 for both. Formula: length * width.");
