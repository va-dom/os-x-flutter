...
import 'package:practice_2/practice_2.dart' as practice_2;
...
void main(List<String> arguments) {
  ...
  print('The quotient of $firstNumber and $secondNumber is: ${practice_2.divide(firstNumber, secondNumber)}');
