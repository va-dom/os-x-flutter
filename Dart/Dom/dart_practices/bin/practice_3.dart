...
void main() {
  ...
  Map<String, dynamic> user1 = createUser(name: "John", age: Random().nextInt(65) + 15);
  print("User 1: ${user1['name']}, ${user1['age']}, ${user1['isActive']}");
  Map<String, dynamic> user2 = createUser(name: "Doe", age: Random().nextInt(65) + 15, isActive: Random().nextBool());
...
void getAreaOfCircle(num r1, num r2) {
  ...
  result = pi * r1 * r2;
  print(
      "for ${pi.toStringAsFixed(2)}, ${r1.toStringAsFixed(2)}, and ${r2.toStringAsFixed(2)}|. area is: ${result.toStringAsFixed(2)}");
}
